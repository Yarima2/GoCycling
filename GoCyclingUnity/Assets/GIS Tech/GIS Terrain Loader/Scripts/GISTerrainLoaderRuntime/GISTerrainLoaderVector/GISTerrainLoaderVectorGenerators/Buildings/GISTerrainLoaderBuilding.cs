...
namespace GISTech.GISTerrainLoader
{
    public class GISTerrainLoaderBuilding : MonoBehaviour
    {
        ...
        public static void CreateBuilding(TerrainContainerObject m_container, GISTerrainLoaderPolygonGeoData buildingData, Transform BuildingParent, GISTerrainLoaderSO_Building m_buildingsPrefab,GISTerrainLoaderSO_Building Default_buildingsPrefab)
        {
            ...
            houseGO.name = "<building_" + buildingtype +"_"+ buildingData.Levels +" " + buildingData.Height+ ">";
            ...
            {
                var h = GISTerrainLoaderBuildingsConstants.wallHeight;
                if (GISTerrainLoaderBuildingsConstants.wallHeight > 5) h = GISTerrainLoaderBuildingsConstants.wallHeight / 2;

                levels += buildingData.Levels;
                height = levels * GISTerrainLoaderBuildingsConstants.wallHeight ;
            }
            ...
            CreateHouseWall(points, height * container.scale.y, DefaultPrefab.wall, scale );
            CreateHouseRoof(points, height * container.scale.y, roofHeight, roofType);
        ...
        private static void CreateHouseWall(List<Vector3> baseVertices, float baseHeight, Material material, Vector2 materialScale)
        {
            ...
            scale.x *= (perimeter / container.scale.y) / 100 * materialScale.x ;
            scale.y *= (baseHeight / container.scale.y*10) / 30 * materialScale.y;
