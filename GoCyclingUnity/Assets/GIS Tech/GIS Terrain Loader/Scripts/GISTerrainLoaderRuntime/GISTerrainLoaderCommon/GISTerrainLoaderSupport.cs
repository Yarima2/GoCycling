...
namespace GISTech.GISTerrainLoader
{
    ...
    {
        public static string[] SupportedDEMFiles = new string[] { ".flt",".bin",".tif",".tiff", ".bil", ".hgt", ".asc", ".las", ".ter", ".png"
        ,".raw"};
        public static string[] GeoFile = new string[] { ".flt", ".bin", ".tif", ".tiff", ".bil", ".hgt", ".asc", ".las" };
